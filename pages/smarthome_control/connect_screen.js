  ...
  set_config_info(config_data) {
    if(config_data == "end") {
      ...
      if(device_name == "roomlight") {
        var place = "";
        for(var i = 0; i < this.data.roomlight.static_data.lights.values.length; i++) {
          if(config_data[this.data.roomlight.static_data.lights.indices[i]] != undefined) {
            place = i;
            break;
          }
        }
        this.data.roomlight.dynamic_data[this.data.roomlight.static_data.lights.values[place]] = config_data[this.data.roomlight.static_data.lights.indices[place]];
      }
    }
  }
